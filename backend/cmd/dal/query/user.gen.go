...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.BehaviorDurationMap = field.NewString(tableName, "behavior_duration_map")
...
func (u *user) updateTableName(table string) *user {
	...
	u.BehaviorDurationMap = field.NewString(table, "behavior_duration_map")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["behavior_duration_map"] = u.BehaviorDurationMap
}
