  ...
  methods: {
    ...
    save() {
      if (this.form.id) {   //update
        request.put("/user/goods/" + this.form.id, this.form).then(res => {
          console.log(res);
          if (res.code === '0') {
            this.$message({
              type: "success",
        ...
        request.post("/user/goods", this.form).then(res => {
          console.log(res)
          if (res.code === '0') {
            this.$message({
              type: "success",
    ...
    handleDelete(plateNumber) {
      ...
      request.delete("/user/goods/" + plateNumber).then(res => {
        if (res.code === '0') {
          this.$message({
            type: "success",
            message: "删除成功"
